...
const translations = {
  ...
  zh: {
    ...
    // START: Services Page Translations
    ...
    // END: Services Page Translations
  }
};
...
const setLanguage = (lang) => {
    ...
    document.querySelectorAll('[data-key]').forEach(elem => {
        ...
        // Try page-specific key first (e.g., 'services-hero-title')
        if (pageId && translations[lang][`${pageId}-${key}`]) {
            translation = translations[lang][`${pageId}-${key}`];
        } 
        // Fallback to generic key (e.g., 'nav-solutions')
